...
<body>
	<form action="AddMember" method="post" id="addCustomerForm">
		<table>
			...
			<tr>
				<td>Gender</td>
				<td><input type="radio" name="gender" id="gender" value="남" class="form-control">남</td>
				<td><input type="radio" name="gender" id="gender" value="여" class="form-control">여</td>
			</tr>
			<tr>
				<td>Addr</td>
				<td><input type="text" name="addr" id="addr" readonly="readonly" class="form-control"></td>
				<td><button type="button" id="addrBrn" onclick="sample2_execDaumPostcode()">주소검색</button></td>
				<td>DetailAddr</td>
				<td><input type="text" name="detailAddr" id="detailAddr" class="form-control"></td>
			</tr>
		</table>
